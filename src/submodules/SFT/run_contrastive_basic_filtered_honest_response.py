...
from pipeline.configs.config_generation_filtered_honest_response import Config
import pprint
import argparse
...
def parse_arguments():
    ...
    # D:\Data\deception
    parser.add_argument("--task_name", type=str, required=False, default="filtered_honest_response")
...
def main(model_path_generation, data_dir, save_dir):
    ...
    ds_list_correct = [ ds_list[ii] for ii in range(len(ds_list))  if ds_list[ii]["honest_score_honest"]==1]
