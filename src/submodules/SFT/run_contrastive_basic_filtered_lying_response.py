...
from pipeline.configs.config_generation_filtered_lying_response import Config
import pprint
import argparse
...
def parse_arguments():
    ...
    # D:\Data\deception
    parser.add_argument("--task_name", type=str, required=False, default="filtered_lying_response")
