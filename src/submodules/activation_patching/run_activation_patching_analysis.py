...
from src.submodules.activation_patching.activation_patching_analysis import (
    plot_cos_sim_and_logit_diff_layer,
)
...
def parse_arguments():
    ...
    parser.add_argument(
        "--jailbreak", type=str, required=False, default="evil-confidant"
    )
...
def main(
    ...
    plot_cos_sim_and_logit_diff_layer(cfg)
