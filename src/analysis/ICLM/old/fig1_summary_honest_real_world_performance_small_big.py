...
for mm in model_path:
    ...
    artifact_path = os.path.join("D:\Data\deception", "runs", "real_world", model_alias)
...
pio.write_image(
    fig, save_path + os.sep + "honest_performance_real_world_all_models.pdf"
)
pio.write_image(
    fig, save_path + os.sep + "honest_performance_real_world_all_models.png", scale=6
)
