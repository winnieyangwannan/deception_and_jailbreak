...
class Config:
    ...
    def artifact_path(self) -> str:
        ...
        return os.path.join(data_dir, "runs", f"{self.task_name}", self.model_alias)
...
def parse_arguments():
    ...
    parser.add_argument(
        "--data_dir", type=str, required=False, default="D:\Data\deception"
    )
    parser.add_argument(
        "--save_dir",
        type=str,
        required=False,
        default="D:\Data\deception\figures\ICLM_submission\sft",
    )
